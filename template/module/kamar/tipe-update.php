				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input class="form-control" name="nama_kamar_tipe" value="<?php echo $kamar_tipe_view['nama_kamar_tipe']; ?>" required />
						</div>
						<div class="form-group">
							<label>Harga / Malam</label>
							<input type="number" class="form-control" name="harga_malam" value="<?php echo $kamar_tipe_view['harga_malam']; ?>" required />
						</div>
					</div>
					<div class="col-sm-4">
						<label>Keterangan</label>
						<textarea class="form-control" name="keterangan" rows="8"><?php echo $kamar_tipe_view['keterangan']; ?></textarea>
					</div>
				</div>
			</div>
