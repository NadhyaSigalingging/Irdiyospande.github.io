...
<div class="wrapper">
	...
	<section class="content-header">
		<h1>Check In <span class="small">Detail Check In</span></h1>
	</section>
		...
		<div class="box">
			...
			<form action="" method="post">
					...
					<div class="row">
						<div class="col-sm-3">
							...
							<div class="alert alert-info">
								...
								<ul class="list-unstyled">
									...
									<li>Maximal Person Adult : <b><?php echo $kamar_view['max_dewasa']; ?> Orang</b></li>
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<select class="form-control nama_tamu" name="id_tamu" required>
						...
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										<input id="checkout" class="form-control" name="tanggal_checkout" data-date-format="yyyy-mm-dd" required />
									</div>
									<div class="col-sm-6">
										<input class="form-control" name="waktu_checkout" value="12:00" required />
									</div>
								</div>
							</div>
							<div class="form-group">
				...
				<div class="box-footer">
					...
					<a class="btn btn-cancel" href="?module=transaksi/checkin">Batal</a>
					<button class="btn btn-custom" type="submit" name="checkin">Check In</button>
				</div>
			</form>
			<?php } ?>
		</div>
